...
I started writing it in early 2012 from a desire for a simple, fast, effective grep tool, primarily for my own use. There was also the more self-serving motive of wanting to put some of the technologies I'd been learning into practice _(things like WPF MVVM, the Managed Extensibility Framework, the Task Parallel Library, and Async and Await)_.
